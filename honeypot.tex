...
The two additional devices shown in shown in Figure~\ref{fig:HPOverview} can be PC's to act as either attacker entry points or target devices such as PC or any additional devices required for the experiments such as access points or PC's supporting virtual machines to extend the honeypots supported facilities. Table~\ref{table:HoneypotCosts} shows the approximate costs of the \texttt{HILV}.
