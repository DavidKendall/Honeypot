...
The \texttt{LIHV} honeypot architecture is an isolated environment. This is provided by using a commercially available cable router that is connected to the main laboratory infrastructure as shown in Figure~\ref{fig:HPOverview}. 
...
\begin{figure}[!ht]
  ...
  \begin{minipage}[h]{0.45\textwidth}
    ...
    \caption{\texttt{LIHV} side view}
    \label{fig:HP1}
  \end{minipage}
  \hfill
  \begin{minipage}[h]{0.45\textwidth}
    \includegraphics[width=\textwidth]{Images/HP2.eps}
    \caption{\texttt{LIHV} top view}
    \label{fig:HP2}
  \end{minipage}
\end{figure}
...
\caption{\texttt{LIHV} Raspberry Pi boards (side view)}
\label{fig:HP3}
\end{center}
\end{figure}
