...
The two additional devices shown in Figure~\ref{fig:HPOverview} could be PC's to act as attack entry points or target devices such as PC's or access points. These devices could also be PC's supporting virtualisation to extend the honeypot's functionality. Table~\ref{table:HoneypotCosts} shows the approximate costs of the basic \texttt{HILV} without additional devices or the monitoring PC attached.
