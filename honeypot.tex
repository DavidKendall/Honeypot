...
\item \noindent \emph{\textbf{HILV}} This type of honeypot is used when carrying out analysis of high levels of inter system communication and interaction where there is only a limited amount of user interaction. This allows the effects of a transaction to be identify throughout a system whilst collecting the minimum amount of data, for example when profiling a Wordpress~\cite{WP:17} site using WPScan~\cite{WT:17}. 
\end{itemize}
